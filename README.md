# my-service-butt serverless API
The my-service-butt project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=my-service-butt -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-spring-archetype -DarchetypeVersion=1.4 -DgroupId=my.service.butt -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd my-service-butt
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "MyServiceButtApi",
                    "OutputKey": "MyServiceButtApi",
