 ...
 */
public class CustomHttpServletRequest extends AwsHttpServletRequest {
    ...
    private static Logger log = LoggerFactory.getLogger(CustomHttpServletRequest.class);
    ...
    public CustomHttpServletRequest(CustomRequest awsProxyRequest, Context lambdaContext, SecurityContext awsSecurityContext) {
        this(awsProxyRequest, lambdaContext, awsSecurityContext, LambdaContainerHandler.getContainerConfig());
    }


    public CustomHttpServletRequest(CustomRequest awsProxyRequest, Context lambdaContext, SecurityContext awsSecurityContext, ContainerConfig config) {
        super(lambdaContext);
    ...
    public CustomRequest getAwsProxyRequest() {
        return this.request;
    }
